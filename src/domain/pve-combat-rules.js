...
export const HUNT_REGIONS = Object.freeze({
  ...
  'dead-hours-bunker': Object.freeze({
    ...
    bossBloodChance: 0.15,
    victoryMessage: 'Los hilos del Tejedor de Horas se quiebran',
  }),
});
